...
int main() {
    ...
    superPoder1 = (float) pop1 + area1 + pib1+ (float) pontos1 + pibPerCapta1 + (1.0/densidade1);
    ...
    superPoder2 = (float) pop2 + area2 + pib2+ (float) pontos2 + pibPerCapta2 + (1.0/densidade2);
